...
* generated by Xtext
*/
package org.makumba.devel.plugin.eclipse.mdd.ui.contentassist.antlr;
...
public class MDDParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.makumba.devel.plugin.eclipse.mdd.ui.contentassist.antlr.internal.InternalMDDParser createParser() {
		org.makumba.devel.plugin.eclipse.mdd.ui.contentassist.antlr.internal.InternalMDDParser result = new org.makumba.devel.plugin.eclipse.mdd.ui.contentassist.antlr.internal.InternalMDDParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFieldDeclarationAccess().getNameAlternatives_0_0(), "rule__FieldDeclaration__NameAlternatives_0_0");
					...
					put(grammarAccess.getTitleAccess().getAlternatives(), "rule__Title__Alternatives");
					...
					put(grammarAccess.getFunctionArgumentBodyAccess().getNameAlternatives_1_0(), "rule__FunctionArgumentBody__NameAlternatives_1_0");
					...
					put(grammarAccess.getIdentPrimaryAccess().getAlternatives_0_2(), "rule__IdentPrimary__Alternatives_0_2");
					...
					put(grammarAccess.getAggregateAccess().getAlternatives_1_2(), "rule__Aggregate__Alternatives_1_2");
					put(grammarAccess.getAggregateAccess().getAlternatives_1_2_1_0(), "rule__Aggregate__Alternatives_1_2_1_0");
					put(grammarAccess.getAggregateAccess().getAlternatives_1_2_1_1(), "rule__Aggregate__Alternatives_1_2_1_1");
					...
					put(grammarAccess.getDataDefinitionAccess().getGroup_1(), "rule__DataDefinition__Group_1__0");
					...
					put(grammarAccess.getAsAliasAccess().getGroup(), "rule__AsAlias__Group__0");
					...
					put(grammarAccess.getAtomAccess().getGroup_1_0(), "rule__Atom__Group_1_0__0");
					put(grammarAccess.getAtomAccess().getGroup_1_0_2(), "rule__Atom__Group_1_0_2__0");
					...
					put(grammarAccess.getIdentPrimaryAccess().getGroup_0_2_0(), "rule__IdentPrimary__Group_0_2_0__0");
					put(grammarAccess.getIdentPrimaryAccess().getGroup_0_2_1(), "rule__IdentPrimary__Group_0_2_1__0");
					put(grammarAccess.getIdentPrimaryAccess().getGroup_0_2_2(), "rule__IdentPrimary__Group_0_2_2__0");
					put(grammarAccess.getIdentPrimaryAccess().getGroup_0_3(), "rule__IdentPrimary__Group_0_3__0");
					...
					put(grammarAccess.getDataDefinitionAccess().getDAssignment_1_0(), "rule__DataDefinition__DAssignment_1_0");
					...
					put(grammarAccess.getPointerAccess().getTypeAssignment_2(), "rule__Pointer__TypeAssignment_2");
					...
					put(grammarAccess.getTitleDeclarationAccess().getTitleAssignment_3(), "rule__TitleDeclaration__TitleAssignment_3");
					...
					put(grammarAccess.getComparisonPartAccess().getTAssignment_0(), "rule__ComparisonPart__TAssignment_0");
					...
					put(grammarAccess.getUpperFunctionAccess().getTAssignment_2(), "rule__UpperFunction__TAssignment_2");
					put(grammarAccess.getLowerFunctionAccess().getTAssignment_2(), "rule__LowerFunction__TAssignment_2");
					...
					put(grammarAccess.getRangeValidationRuleDeclarationAccess().getArgsAssignment_1(), "rule__RangeValidationRuleDeclaration__ArgsAssignment_1");
					put(grammarAccess.getRangeValidationRuleDeclarationAccess().getRangeAssignment_3(), "rule__RangeValidationRuleDeclaration__RangeAssignment_3");
					...
					put(grammarAccess.getRegexValidationRuleDeclarationAccess().getArgsAssignment_1(), "rule__RegexValidationRuleDeclaration__ArgsAssignment_1");
					put(grammarAccess.getRegexValidationRuleDeclarationAccess().getExpAssignment_3(), "rule__RegexValidationRuleDeclaration__ExpAssignment_3");
					...
					put(grammarAccess.getFunctionArgumentsAccess().getAAssignment_2_0(), "rule__FunctionArguments__AAssignment_2_0");
					put(grammarAccess.getFunctionArgumentsAccess().getAAssignment_2_1_1(), "rule__FunctionArguments__AAssignment_2_1_1");
					...
					put(grammarAccess.getFromClassOrOuterQueryPathAccess().getAsAliasAssignment_2(), "rule__FromClassOrOuterQueryPath__AsAliasAssignment_2");
					...
					put(grammarAccess.getAsAliasAccess().getAliasAssignment_1(), "rule__AsAlias__AliasAssignment_1");
					...
					put(grammarAccess.getAtomAccess().getEAssignment_1_0_2_1(), "rule__Atom__EAssignment_1_0_2_1");
					put(grammarAccess.getAtomAccess().getExpAssignment_1_1_1(), "rule__Atom__ExpAssignment_1_1_1");
					put(grammarAccess.getPrimaryExpressionAccess().getIdentAssignment_0_1(), "rule__PrimaryExpression__IdentAssignment_0_1");
					put(grammarAccess.getPrimaryExpressionAccess().getSAssignment_3_1_1(), "rule__PrimaryExpression__SAssignment_3_1_1");
					...
					put(grammarAccess.getIdentPrimaryAccess().getEAssignment_0_3_1(), "rule__IdentPrimary__EAssignment_0_3_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.makumba.devel.plugin.eclipse.mdd.ui.contentassist.antlr.internal.InternalMDDParser typedParser = (org.makumba.devel.plugin.eclipse.mdd.ui.contentassist.antlr.internal.InternalMDDParser) parser;
	...
	protected String[] getInitialHiddenTokens() {
		return new String[] { "RULE_WS", "RULE_SL_COMMENT", "RULE_FIELDCOMMENT" };
	}
